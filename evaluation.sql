...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2019 at 10:07 AM
...
(12, 'student1', 'student1', 0, 0),
(13, 'teacher1', 'teacher1', 0, 0),
(14, 'teacher5', 'teacher5', 0, 0),
(15, 'teacher3', 'teacher3', 0, 0),
(16, 'teacher4', 'teacher4', 0, 0),
(17, 'teacher2', 'teacher2', 0, 0),
(18, 'student1', 'student1', 0, 0),
(19, 'student2', 'student2', 0, 0),
(20, 'student3', 'student3', 0, 0);
...
(1, 'The teacher is generally well-organized and prepared for class.', 1),
(2, 'The teacher maintains enough classroom discipline', 1),
(3, 'Class time is used in an efficient and productive manner.', 1),
(4, 'Tests and assignments are corrected and returned to me, and I know where I stand 	in this class in terms of my grade.', 1),
(5, 'presented subject matter clearly and systematically.', 1);
...
(1, 'Monday, Wednesday, Friday', '07:30:00', '08:30:00'),
(2, 'Monday, Wednesday, Friday', '08:30:00', '09:30:00'),
(3, 'Tuesday, Thursday', '07:30:00', '09:30:00'),
(4, 'Tuesday, Thursday', '09:00:00', '10:30:00'),
(5, 'Monday To Friday', '09:00:00', '11:00:00');
...
(7, '', 'Janine', 'Arrabis', 'A', 2),
(8, '', 'Jerson', 'Charles', 'C', 4),
(9, '', 'Jasper ', 'Malubay', 'G', 1),
(10, '', 'Jed', 'Reviral', 'S', 1),
(11, '', 'Gerald', 'Hubakon', 'S', 1);
...
--
ALTER TABLE `student_account`
  MODIFY `StudentAccountId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `teacher_account`
  MODIFY `TeacherAccountId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
